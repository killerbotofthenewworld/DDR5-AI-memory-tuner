...
def render_manual_tuning_tab(config: DDR5Configuration) -> DDR5Configuration:
    ...
    st.info(
        "🎯 **Direct Control**: Manually adjust all DDR5 timing parameters "
        "for precise tuning"
    )
    ...
    with col1:
        ...
        _base_cl = max(16, int(config.frequency * 0.0055))  # noqa: F841
        _default_trcd = max(16, int(config.frequency * 0.006))  # noqa: F841
        _default_trp = max(16, int(config.frequency * 0.0055))  # noqa: F841
        _default_tras = max(32, int(config.frequency * 0.0125))  # noqa: F841
    ...
    with col2:
        ...
        manual_tfaw = st.number_input(  # noqa: F841 - UI control, value not used
        ...
        manual_trrds = st.number_input(  # noqa: F841 - UI control, value not used
        ...
        manual_trrdl = st.number_input(  # noqa: F841 - UI control, value not used
        ...
        manual_tccdl = st.number_input(  # noqa: F841 - UI control, value not used
